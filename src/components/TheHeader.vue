<template>
    <header id="header" class="w-100">
        <div class="container py-3 d-flex flex-row justify-content-between">
            ...
            <div class="input-group balance-container">
                <div id="balance-background">
                    <p id="balance">{{ formattedBalance }}</p>
                </div>
...
const formattedBalance = computed(() => Utils.formatCurrency(balance.value));

watchEffect(() => (balance.value = store.getters.cashBalance()));
</script>
